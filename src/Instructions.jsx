...
const TaskTutorialTwo = (props) => {
    ...
    const text1 = <span>
        ...
        <p>For example, below we show the same machine in two different configurations. Changing the color of the node at the top can change the color of the node it is wired into.</p>
    </span>;
...
const TaskTutorialThree = (props) => {
    ...
    const text = <span>
        ...
        <p>In this experiment we will show you two different sets of machines.</p>
        <p>For each set, we will first give you information about how the machines work. Then we will show you some machines, and ask you why the lower node in these machines is in the state that it is in. </p>
    </span>
